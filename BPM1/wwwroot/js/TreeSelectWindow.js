...
mini.extend(TreeSelectWindow, mini.Window, {
    ...
    initControls: function () {
        ...
        var t = this.tree; 
        var o = this;
        this.tree.on("nodedblclick", function () {
            mini.get("btnEdit1").setText(t.getSelectedNode().Title);
            mini.get("btnEdit1").setValue(t.getSelectedNode().ID);
            tData = t.getList();
            $("#cFlag").val("0");
            o.hide();
        }); 
